...
- July 31, 2025: ✅ **Pushcut URL Updated** - Nova notificação configurada:
  * Nova URL: https://api.pushcut.io/NiUWvkdg8_MMjxh6DOpez/notifications/Venda%20Pendente
  * Título da notificação alterado para "Venda Pendente"
  * Mantém dados reais: nome do cliente, valor R$ 45,84, transaction ID
  * Campo "text" restaurado com detalhes: nome do cliente, valor R$ 45,84, transaction ID
- July 31, 2025: ✅ **MEDIUS PAG Credentials Updated** - Nova conta configurada:
  * Nova Secret Key: sk_live_0UfYGKXXU43iuMnIQzzpKRpb9BRgHf6LJmckw68JZVmV6pgD
  * Novo Company ID: 94c91ae2-3ae2-4860-942f-75f8fbd3b627
...
- July 31, 2025: ✅ **Real Lead Data Integration Enhanced** - Dados reais sempre priorizados:
  ...
  * Busca automática de dados reais via API fontesderenda quando CPF detectado
  * Prioriza dados da sessão se já foram carregados
  * Fallback inteligente apenas se não conseguir extrair CPF válido
  * Logs detalhados para debug do processo de extração de dados
  * Garantia de que transações PIX sempre usam dados reais do lead